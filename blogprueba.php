...
<head>
    ...
    <li class="nav-item">
 <a class="nav-link text-decoration-none" href="#" onclick="ga('send', 'event', 'navbar')"><span class="home">Home</span></a>
...
<!--*****************************PAGINACION********************-->
  ...
  $sql_articulos="SELECT * FROM contenido ORDER BY ID DESC LIMIT :iniciar, :narticulos"; 
...
<!--------------------------------------------------------------->
 ...
 ?></h1>
    ...
    <span class="post-date">
    	<font style="vertical-align: inherit;">
    		<?php echo  $debuelve['Fecha'] . " Hace un momento " ; ?>
    	</font>
    </span>
    	...
    	<?php 
    	if ($debuelve['Imagen']!="") {
        echo "<img src='Imagenes/" . $debuelve['Imagen'] . "' width='80%' height='390px' align='center'/>";
        } 
